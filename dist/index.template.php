...
function template_init()
{
	...
	$settings['color_palettes'] = array(
		'default' => array(
			'background' => '#00042d',
			'foreground' => '#e6e6e6',
			'primary_color' => '#0c0c3a',
			'secondary_color' => '#2b3060',
			'links' => '#c1cce1',
			'gradient_end' => '#110d31',
			'gradient_start' => '#12163d',
			'blocks_color' => '#0c0d3d',
			'blocks_alternate_color' => '#0c123a',
			'content_target_bg' => '#3c163f',
			'borders_color' => '#241f52',
			'top_section' => '#3e3a5c',
			'footer' => '#15133c',
			'buttons_text_color' => '#404040',
			'buttons_bg' => '#999999',
			'buttons_border' => '#adadad',
			'special_titles_color' => '#b95c00',
			'sticky_topic' => '#1e1634',
			'sticky_locked_topic' => '#1b102c',
			'unapproved_topic' => '#111742',
			'locked_topic' => '#221f3a',
			'remove_shadows' => true
		)
	);
